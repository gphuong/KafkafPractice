...
public class ConsumerCustomers {
    public static void main(String[] args) throws Exception{
        ...
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, Schemas.Topics.CUSTOMERS.keySerde().deserializer().getClass());
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, Schemas.Topics.CUSTOMERS.valueSerde().deserializer().getClass());
