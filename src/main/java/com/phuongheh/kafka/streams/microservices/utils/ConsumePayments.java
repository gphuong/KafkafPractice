...
public class ConsumePayments {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, Schemas.Topics.PAYMENTS.keySerde().deserializer().getClass());
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, Schemas.Topics.PAYMENTS.valueSerde().deserializer().getClass());
