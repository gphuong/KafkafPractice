...
public class ConsumeOrders {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, Schemas.Topics.ORDERS.keySerde().deserializer().getClass());
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, Schemas.Topics.ORDERS.valueSerde().deserializer().getClass());
