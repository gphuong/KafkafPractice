...
public class PriorityQueueSerde<T> implements Serde<PriorityQueue<T>> {
    ...
    public PriorityQueueSerde(Comparator<T> comparator, Serde<T> avroSerde) {
        this.inner = Serdes.serdeFrom(new PriorityQueueSerializer<>(comparator, avroSerde.serializer()),
